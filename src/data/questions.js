export const questions = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'coursework', label: 'Relevant Coursework (optional)', type: 'textarea', placeholder: 'Data Structures, Algorithms, Operating Systems, Machine Learning', required: false, rows: 2 },
    ]
  },
  {
    id: 'experience',
